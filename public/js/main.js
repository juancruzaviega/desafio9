...
const users = {
    juan: { id: 1, email: "juan@gmail.com", name: "juan" },
    nahuel: { id: 2, email: "nahue@cabe.com", name: "nahuel" },
    mateo: { id: 3, email: "mateo@batata.com", name: "mateo" },
    javier: { id: 4, email: "javi@yahoo.com", name: "javier" }
}
